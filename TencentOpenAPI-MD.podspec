#
#  Be sure to run `pod spec lint TencentOpenAPI-MD.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author       = { "modo" => "chenjiaxian@modo.cn" }
  # Or just: spec.author    = "modo"
  # spec.authors            = { "modo" => "" }
  # spec.social_media_url   = "https://twitter.com/modo"
  ...
  spec.resource               = 'TencentOpenAPI/TencentOpenApi_IOS_Bundle.bundle'
